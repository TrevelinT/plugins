...
// by Danilo Muller, José Rosa and Raphael Guastaferro

// IIFE para proteção caso seja usado em algum lugar que o "$" não seja jQuery
(function($, window, document, undefined) {
   $.fn.djrCarrousel = function() {
        
    console.log("Funfou!");
   } 
})(jQuery, window, document); //undefined num é passado pra realmente ser undefined :)
